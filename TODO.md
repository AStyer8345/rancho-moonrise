...
- **Hipcamp curation gap audit — DONE 2026-05-16.** Output at `brand/2026-05-16-hipcamp-curation-gap-audit.md`. Cause is listing-configuration (3 structural flags + 8 content gaps), not editorial judgment; distance is not the problem. See NEEDS ADAM #2 above for the strategic question this audit raised.
