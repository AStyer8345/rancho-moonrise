...
### NEEDS ADAM — Expedia: 6 reviews, reply coverage never checked, and a promotion rule that is now stuck (~30 sec) — added 2026-08-19 by `rancho-review-monitor`, **escalated 2026-08-21**
...
### NEEDS ADAM — Google's review count is 94 days old, and the fallback is quoting our own website back to us (~30 seconds) — added 2026-08-19 by `rancho-review-monitor`, re-verified 2026-08-21
...
### NEEDS ADAM — Eight open blockers, and seven of them are the same problem (~one decision) — added 2026-08-21 by `rancho-review-monitor`

`expedia-direct-fetch` opened this run, bringing this task to **eight** open blockers. The count is less interesting than the shape: **seven of the eight are the identical failure** — no direct-fetch path to a review surface.
...
### NEEDS ADAM — ResortPass has 53 reviews and nobody is watching it (~2 min) — added 2026-08-17 by `rancho-review-monitor`, **re-verified 2026-08-21 (3rd run carrying this)**
