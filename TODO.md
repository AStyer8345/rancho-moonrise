...
Last updated: 2026-07-15 (rancho-site-daily — 36th consecutive cruise-control firing, no shipped edits. GOALS.md still week-of-5/18 ("No Rancho Moonrise active work — paused; cruise control only if Ashley moves"), last touched 2026-07-02 (LoanOS-only; Rancho line unchanged); no Ashley move. Surgical CreativeWork-property runway on BlogPosting JSON-LD closed 5/26 — no autonomous slot; Person-author + AggregateRating-on-BlogPosting deferred again. Re-Verify Gate live 7/7 still_true, 0 resolved: apex 200 + Vercel + cache HIT (age 877067 ≈10.15d, no redeploy since ~7/5); www 308→apex; sitemap/corp-retreats/safari-tents/blog all 200; BlogPosting CreativeWork 6-prop spot-check on /blog/glamping-near-austin-texas/ intact 50d post-5/26. Continuity fix: 7/6 run (35th) log orphaned untracked (concurrent notebooklm-sync committed over top at 919653a) — committed here by explicit path alongside today's; last committed site-daily was 7/5 (34th) at 1803e02; gap 7/7–7/14. NEEDS ADAM #0 pause-list fix now 49 days overdue (5/27 surface). Run-log: `run-logs/2026-07-15-seo.md`. Prior header: 2026-07-05 rancho-site-daily — 34th consecutive cruise-control firing, Re-Verify Gate 7/7 still_true; 7/4 SEO log committed cb3046a. Run-log: `run-logs/2026-07-05-seo.md`.)
...
4. **ResortPass — activate or formally kill (~30s with Ashley).** 42+ day decision drift on a live-but-dormant zero-product listing. Even the no-product middle ground (publish hours, like Lucky Arrow) beats leaving it dormant.
...
1. **🆕 POST 2 REVIEW REPLIES — drafts ready in `brand/review-reports/2026-05-19-review-report.md`. DAY 47 UNPOSTED IN MONITOR (RUN_063, 2026-07-04).** (a) **Cassie Butterfield (Google 5★, ~49 days old, ~2026-05-16)** — corporate-retreat review, drafted reply is voice-clean and ready to paste as-is in GBP dashboard, 30 seconds. (b) **Haylee L. (The Knot 1★, 2026-02-26, ~128 days / ~18 weeks unreplied)** — quiet-property-risk complaint from a site visit, drafted reply has an edit-flag on the "we're flagging neighboring-property activity..." sentence — 2-minute decision on whether to publicly commit to that operational change before posting. **Visibility cost:** Haylee's verbatim review body still surfaces in Rancho-attributed snippets even on name-free queries — bad-review exposure persists, raising the cost of continued non-reply. **After posting, mark `rancho-review-replies-2026-05-20` done from the briefing page** so this monitor can stop carrying it forward.
2. **ResortPass listing exists — activate or formally kill (~30s with Ashley).** [resortpass.com/hotels/rancho-moonrise](https://www.resortpass.com/hotels/rancho-moonrise) is LIVE but dormant. **42-day decision drift since 5/18 surface (6/29).** Correct address (20117 Lockwood Rd), 3-star, pool hours 10am–6pm daily. Products section empty. Decision: "add day-pass products and activate" OR "leave dormant and remove from TODO." **6/15:** Lucky Arrow's dormant ResortPass listing (hours unchanged — daily Pool 12pm–10pm + Fri–Sun bar 2–6pm, 0 products) remains the no-product middle ground Rancho could adopt if undecided. Parked while Rancho is on cruise control.
...
## 📌 Competitive intel quick wins (refreshed 2026-06-29)

- **🔄 6/15 "aggregator surge" REVERSED — it was a one-week artifact.** Property domains reclaimed the top across glamping head terms: Udoscape recovered #1 (glamping), Safari for the Soul to #1 (safari-tent), Spoon Mountain to #1 (romantic). Hipcamp + Glamping Hub slid below property sites on the core glamping term. NOT a structural shift — explicitly not carried forward. **Durable read (opposite of last week):** property domains that publish strong guide/listicle content win these terms.
...
- **🔄 Spoon Mountain — price up + romantic page moved.** Starting rate ~$245 → "starting $300–500/night". Old `/romantic-weekend-getaways-near-austin/` now 404s; content relocated to `/travel-to-wimberley/romantic-weekend-getaways-near-austin/`, still #1 on narrow term. (done-log)
- **🔄 Corporate-retreat cluster churned; Yurtopian re-entry reverted.** Sage Hill #1; Crystal Creek re-entered #2; Lucky Arrow re-entered #7; Walden #6; Camp Lucy surfaced #9; **The Yurtopian dropped back off** after its one-week ~#3 cameo. Volatile bottom half; Rancho can't enter until `/corporate-retreats/` is crawled (~59d).
- **Hipcamp curated "20 Best Glamping Near Austin" — did NOT rotate again** (Urban Hideout #1, Cozy Cactus Airstream #2, Lucky Arrow #9 all held). Rancho absent **6th consecutive read**. Byte-stable two weeks. Reinforces Hipcamp Ashley question (NEEDS ADAM #3).
- **Rancho ResortPass listing EXISTS, dormant — decision drift now 42 days past 5/18 surface** ([resortpass.com/hotels/rancho-moonrise](https://www.resortpass.com/hotels/rancho-moonrise)). See NEEDS ADAM #2. Middle-ground: publish operating hours like Lucky Arrow, without committing products.
- **Lucky Arrow ResortPass dormant — hours unchanged 6/29** (daily Pool 12–10pm + Fri–Sun bar 2–6pm, 0 products). No movement toward products.
...
- **⚠️ Hotels.com fetch blocked 6/29** — banned "20 cabins / 50 guests" copy still in live search index (7th wk); on-page UNVERIFIED this run. Needs browser-based check. See NEEDS ADAM.
