...
### NEEDS ADAM — Dead YouTube video live on `/videos/` (30 seconds) — day 24, added 2026-07-23 by `rancho-site-daily`

The video card **"Escape to Rancho Moonrise"** on `/videos/` points at YouTube ID `_klefu2vTwM`, which is **removed or private**. Re-verified live today (2026-08-16): thumbnail returns **404**, oembed returns **403**. The other three video IDs on the page all return 200/200, so this is isolated to one card.
