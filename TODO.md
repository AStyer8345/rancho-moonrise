...
Last updated: 2026-05-18 (rancho-competitive-weekly — Two material findings this week. Rancho Moonrise has a live ResortPass listing (dormant, 0 products) — reframes 5 weeks of "submit?" debate. Google has started indexing the apex (11+ pages) — bottleneck narrowed; `/corporate-retreats/` and `/safari-tents-near-austin/` still uncrawled. Safari for the Soul + Walden Retreats both shifted brand-mix / SERP-copy on safari-tent vertical.)

## 🔥 NEEDS ADAM (highest leverage this week)

1. **🆕 ResortPass listing exists — activate or formally kill (~30s with Ashley).** [resortpass.com/hotels/rancho-moonrise](https://www.resortpass.com/hotels/rancho-moonrise) is LIVE but dormant. Correct address (20117 Lockwood Rd), 3-star, pool hours 10am–6pm daily, listing copy mentions ranch views. Products section empty — "no active products at the moment." Either Adam/Ashley submitted previously and the listing went idle, or ResortPass created it speculatively. **Five weeks of "should we submit?" is the wrong question.** The actual decision is "add day-pass products and activate" OR "leave dormant and remove from TODO." A 30-second confirmation with Ashley settles this.
