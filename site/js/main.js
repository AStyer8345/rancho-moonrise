...
(function () {
    ...
    // ---------- Analytics tracker ----------
    // Placeholder only: set these IDs when Adam provides GA4/GTM. Until then,
    // rmTrack keeps emitting to dataLayer/gtag if another snippet loads them.
    window.RANCHO_ANALYTICS_CONFIG = window.RANCHO_ANALYTICS_CONFIG || {
        ga4MeasurementId: '',
        gtmContainerId: ''
    };
    ...
    // Real Calendly URLs (verified in environment). The virtual-tour path does
    // not yet have its own Calendly link, so labels say "Ask about" and the
    // link falls back to the wedding inquiry form until Adam provides a URL.
    var CALENDLY_URLS = {
        tour:    'https://calendly.com/rancho_moonrise/connect',
        call:    'https://calendly.com/monet-b30w/30min',
        virtual: '/contact/?intent=wedding'
    };

    document.querySelectorAll('.calendly-placeholder').forEach(function (link) {
        var type = link.getAttribute('data-calendly');
        var target = CALENDLY_URLS[type] || '/contact/?intent=general';
    ...
    (function () {
        ...
        var KB = [
            ...
            { section: 'wedding', keywords: ['wedding package', 'wedding price', 'wedding cost', 'how much wedding', 'wedding pricing', 'wedding rate', 'wedding budget', 'cost of wedding', 'price of wedding', 'wedding quote'],
              answer: 'Wedding pricing depends on date, guest count, bar package, lodging, and full-ranch access. The fastest way to get an accurate quote is a venue tour — we walk the property and match you to the right package. <a href="/contact/?intent=wedding">Send a wedding inquiry</a> or call <a href="tel:+17372911260">737-291-1260</a> and we\'ll follow up with availability and next steps.' },
            { section: 'wedding', keywords: ['ceremony site', 'ceremony option', 'where ceremony', 'venue option'],
              answer: 'We offer <strong>unlimited ceremony options</strong> across the property — from the Rustic Corral surrounded by wildflowers, to the Event Barn (modern, climate-controlled), to poolside, to open Texas fields with panoramic views. Each creates a completely different atmosphere. <a href="/weddings/#ceremony-sites">Learn more &rarr;</a>' },
            { section: 'wedding', keywords: ['capacity', 'how many', 'guest count', 'guests', 'max', 'maximum', 'seat'],
              answer: 'Rancho Moonrise accommodates up to <strong>200 guests</strong> for weddings and events. The Event Barn seats 150 for a dinner; the Covered Pavilion holds 40; the Neon Moon Bar and Corral each hold up to 50. Events with 75+ vehicles require a shuttle service. <a href="/contact/?intent=wedding">Discuss your guest count &rarr;</a>' },
            { section: 'wedding', keywords: ['tour', 'visit', 'see the ranch', 'come see', 'walk through', 'schedule tour'],
              answer: 'We\'d love to show you around! Schedule an <strong>in-person venue tour (60 min)</strong>, or ask about a virtual walkthrough if you can\'t visit the ranch yet. Call <a href="tel:+17372911260">737-291-1260</a> to schedule, or <a href="/contact/?intent=wedding">submit an inquiry</a> and we\'ll set one up.' },

            // Accommodations
            { section: 'stay', keywords: ['cabin', 'tent', 'glamping', 'stay', 'overnight', 'accommodation', 'sleep', 'room', 'lodge'],
              answer: 'We offer <strong>cabins and safari tents</strong> — all with A/C, heat, real beds, linens, pool towels, mini-fridge, and coffee maker. <strong>Cabins</strong> (queen, sleeps 2), <strong>Family Safari Tents</strong> (queen + bunks, sleeps 4), <strong>Double Safari Tents</strong> (2 queens, sleeps 4), <strong>Premium Bath Tents</strong> (queen or king with private ensuite). No gear required — just show up. <a href="https://hotels.cloudbeds.com/en/reservation/5tzv1r" target="_blank">Check availability &rarr;</a>' },
            { section: 'stay', keywords: ['book', 'reservation', 'reserve', 'availability', 'available'],
              answer: 'You can check real-time availability and book directly: <a href="https://hotels.cloudbeds.com/en/reservation/5tzv1r" target="_blank"><strong>Book your stay &rarr;</strong></a>. For weddings and events, <a href="/contact/">contact us</a> for custom availability.' },
            { section: 'stay', keywords: ['price', 'cost', 'rate', 'per night', 'nightly', 'how much', 'pricing'],
              answer: 'Nightly rates vary by accommodation type and season. Check current pricing and availability on our <a href="https://hotels.cloudbeds.com/en/reservation/5tzv1r" target="_blank">booking page</a>. For wedding and event pricing, <a href="/contact/">send us an inquiry</a> and we\'ll follow up with details — a venue tour is the fastest way to get an accurate quote.' },

            // Events
            { section: 'event', keywords: ['event', 'corporate', 'retreat', 'birthday', 'party', 'conference', 'festival', 'host'],
              answer: 'We host all types of events: corporate retreats, birthday parties, conferences, private parties, festivals, and wellness retreats. Available for <strong>hourly rental or full ranch buyout</strong>. <a href="/contact/?intent=event">Submit an event inquiry &rarr;</a>' },
            ...
            { section: 'event', keywords: ['bar', 'drinks', 'cocktail', 'lounge', 'beverage', 'alcohol', 'beer', 'wine'],
              answer: 'The Lodge serves drinks for overnight guests. For private events and weddings, alcohol is handled through the venue (open bar, per person, per hour) — no outside alcohol or BYOB. Bar packages are priced based on guest count and event length, and we\'ll walk through options on a tour or planning call. <a href="/contact/?intent=event">Send an event inquiry &rarr;</a>' },
            { section: 'event', keywords: ['upcoming event', 'what\'s happening', 'next event', 'calendar', 'schedule'],
              answer: 'Check out our upcoming events — live music, yoga, crawfish boils, and more: <a href="/events/"><strong>View upcoming events &rarr;</strong></a>' },
            ...
            { section: 'policy', keywords: ['caterer', 'catering', 'food', 'bring own', 'vendor', 'byob', 'outside vendor'],
              answer: 'We work with both preferred vendors and outside vendors. For weddings and events, we can share our <strong>preferred vendor list</strong> and discuss catering policies during your consultation. <a href="/contact/?intent=wedding">Inquire for details &rarr;</a>' },
            { section: 'policy', keywords: ['cancel', 'cancellation', 'refund', 'policy', 'policies'],
              answer: 'For accommodation cancellation policies, check your booking confirmation. For wedding and event cancellation terms, these are outlined in your event contract. Questions? Call <a href="tel:+17372911260">737-291-1260</a> or see our <a href="/policies/">policies page</a>.' },
            ...
            { section: 'stay', keywords: ['included', 'amenities', 'amenity', 'linen', 'towel', 'coffee', 'breakfast', 'kitchen', 'fridge', 'what comes with'],
              answer: 'All units include <strong>linens, pool towels, mini-fridge, and coffee maker</strong>. Hot coffee is available in the Lodge. No full kitchen in units — a full Lodge kitchen rents for $50/hr or $200/day. No gear needed.' },
            ...
            { section: 'event', keywords: ['retreat', 'corporate retreat', 'buyout', 'all inclusive', 'overnight retreat', 'group rate', 'full ranch', 'exclusive'],
              answer: 'Full-ranch buyouts for groups: <strong>$3,500/night Sun–Wed</strong> or <strong>$4,500/night Thu–Sat</strong>. Includes lodging access, the Event Barn, Lodge conference room, and coffee. Add yoga ($150), sound baths ($300), horseback riding, two-step lessons, and more. <a href="/contact/?intent=event">Inquire for retreat pricing &rarr;</a>' },
        ];

        // Default / fallback
        var FALLBACK = 'I\'m not sure about that one — but our team can help! Call <a href="tel:+17372911260">737-291-1260</a> or <a href="/contact/">send us a message</a>. We respond within 2 hours.';
