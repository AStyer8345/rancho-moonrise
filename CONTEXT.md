...
**Last updated:** 2026-04-21 (Admin panel Galleries build: auto-sort events by closest date first, added Galleries admin tab with CRUD for 5 gallery sections, seeded 64 photo rows into rancho_photos from existing hardcoded HTML, expanded section CHECK constraint to 9 values, hydrated 4 public pages — events.html, weddings.html (lightbox preserved via event delegation + gallery:hydrated event), pool-day-pass-austin.html, accommodations.html (lodge + ranch_tour).)
