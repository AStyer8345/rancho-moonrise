...
- 2026-05-01 (review-monitor RUN_015): Google WebSearch snippet flipped 175 → 126 → 175 across 15 runs (4-state ping-pong). Snippet conclusively unreliable; review-count claims still belong to `rancho-review-monitor`. 3 BLOCKERS at 15 runs (Google count, Hotels.com timeout, Airbnb 403). NEEDS ADAM: GBP dashboard count (60s) or Places API key.
