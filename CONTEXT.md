...
- 2026-05-16 (review-monitor RUN_030): **Google count snippet HELD at 126 @ 4.9★ — 5th consecutive post-dip confirmation (RUN_026/027/028/029/030).** First WebSearch query surfaced "4.9 stars with 126 reviews" inline. Pattern across 30 runs: 126→175→126→175→126→126→126→126→126→126→126→126→126→ABSENT→126→126→126→126→126 — 14-of-15 stable with one mid-stretch dip; recovery is five-for-five. Snippet still lower-confidence (three prior 126↔175 flips); BLOCKER on authoritative live scrape unchanged (30th). TripAdvisor live: 0 reviews, unclaimed; **price DRIFTED $65-$175 → $64-$175** (floor -$1, ceiling unchanged — new cumulative floor low since drift tracking began at $77). 19-run net drift floor $77→$64 / ceiling $181→$175 (floor net -$13, ceiling net -$6). Travelers' Choice text NOT attributed to Rancho Moonrise (8th consecutive run; today's WebFetch quoted: "No award is attributed to this specific property."). **Hipcamp live-scrape RECOVERED** — WebFetch succeeded both attempts after yesterday's one-run "Loading..." dip; identical state to RUN_028 (0 reviews, 1 booking singular, joined March 2024); stale flag cleared, scrape_failure_count reset 1→0. **Expedia 8.0 rating value INLINE again** — recovers from RUN_029's one-run absence (mirrors RUN_021→RUN_022 pattern); 8 of last 9 runs inline. Hotels.com listing ho2867109568 still active. Facebook 5/100% recommend stable — 12th consecutive run. The Knot in result list but no count detail re-surfaced (5 consecutive runs without count). Unreplied=0 holds on done-log signal (no review-related done-log entries since RUN_011). 3 BLOCKERS at 30 runs (Google count, Hotels.com timeout, Airbnb 403). NEEDS ADAM unchanged: GBP dashboard count (60s) or Places API key — snippet pattern remains lower-confidence stable, but a one-time dashboard check would convert it to ground truth.
