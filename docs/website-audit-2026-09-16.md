...
- **Deployment maintenance:** upgraded the server runtime from Node 20 to Node 24 after Vercel warned that new Node 20 deployments will stop working October 1. Both API handlers passed offline compatibility checks with all upstream calls mocked. [Vercel notice](https://vercel.com/changelog/node-js-20-is-being-deprecated)
